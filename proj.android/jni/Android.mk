...
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GameEnd/*.cpp)
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GamePlay/*.cpp)
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GamePlay/Character/*.cpp)
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GamePlay/Character/Player/*.cpp)
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GamePlay/Character/Test/*.cpp)
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GamePlay/Object/*.cpp)
FILE_LIST := $(wildcard $(LOCAL_PATH)/../../Classes/GamePlay/Scene/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../Classes/GameTitle/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../Classes/SceneSupport/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../Classes/Template/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../Classes/Test/*.cpp)
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GameEnd
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GamePlay
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GamePlay/Character
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GamePlay/Character/Player
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GamePlay/Character/Test
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GamePlay/Object
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GamePlay/Scene
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/GameTitle
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/SceneSupport
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/Template
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../Classes/Test
